...
//THIS IS SCRIPT IS ATTACHED TO ALL THE PAGES SO THEY CAN INHERIT FROM THE BEHAVIOURS SPECIFIED HERE

const generateButton = document.querySelector('[data-randomBtn]')
const on_palette_page = window.location.pathname === '/generator.html'
